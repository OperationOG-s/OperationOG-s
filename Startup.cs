...
namespace PortableRecipes
{
  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddDbContext<PortableRecipesContext>(options =>
      {
        options.UseSqlite(Configuration.GetConnectionString("PortableRecipesConnection"));
      });
      ...
      {
        options.CookieName = ".PortableRecipes.Session804";
