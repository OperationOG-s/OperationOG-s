...
export function Mediterranean_Categorie_Recipe_can_create(self:MediterraneanContext) {
  let state = self.state()
...
export function Mediterranean_Categorie_Recipe_can_delete(self:MediterraneanContext) {
  let state = self.state()
...
export function Mediterranean_Categorie_Recipe_page_index(self:MediterraneanContext) {
  let state = self.state()
...
export function Mediterranean_Categorie_Recipe_page_size(self:MediterraneanContext) {
  let state = self.state()
...
export function Mediterranean_Categorie_Recipe_search_query(self:MediterraneanContext) {
  let state = self.state()
...
export function Mediterranean_Categorie_Recipe_num_pages(self:MediterraneanContext) {
  let state = self.state()
...
export function load_relation_Mediterranean_Categorie_Recipe(self:MediterraneanContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Recipe(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Categorie_Categorie_Recipes(self.props.entity, Mediterranean_Categorie_Recipe_page_index(self), Mediterranean_Categorie_Recipe_page_size(self), Mediterranean_Categorie_Recipe_search_query(self)).then(Recipes =>
        self.setState({...self.state(), update_count:self.state().update_count+1,
...
export function load_relations_Mediterranean(self, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  load_relation_Mediterranean_Categorie_Recipe(self, false, self.props.current_User, self.props.current_Admin, 
  ...
  return <div className="local-menu">
        ...
        {!Permissions.can_view_Recipe(self.props.current_User, self.props.current_Admin) ? null :
                  <div key={"Categorie_Recipe"} className={`local_menu_entry${self.props.shown_relation == "Categorie_Recipe" ? " local_menu_entry--active" : ""}`}>
                    <a onClick={() =>
                      load_relation_Mediterranean_Categorie_Recipe(self,
                        false,
                        self.props.current_User, self.props.current_Admin, 
...
export function render_Mediterranean_Categorie_Recipe(self:MediterraneanContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("mediterranean_categorie_recipe",
   "Categorie",
   "Recipe",
   "Recipes",
   self.props.nesting_depth > 0,
  ...
  (
      state.Recipe != "loading" ?
        ...
        state.Recipe,
      Mediterranean_Categorie_Recipe_page_index(self),
      Mediterranean_Categorie_Recipe_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Recipe != "loading" &&
          self.setState({...self.state(),
...
export function render_add_existing_Mediterranean_Categorie_Recipe(self:MediterraneanContext) {
...
export function render_new_Mediterranean_Categorie_Recipe(self:MediterraneanContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Categorie_Categorie_Recipes_Recipe(self.props.entity).then(e => {
                              ...
                              Api.update_Recipe(
                                ...
                                load_relation_Mediterranean_Categorie_Recipe(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Recipe:"closed"})
                                  )
                                )
                          })
