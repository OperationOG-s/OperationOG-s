...
export function Mediterranean_Categorie_Meal_can_create(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? false : state.Meal.CanCreate
}
export function Mediterranean_HomePage_Categorie_can_create(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? false : state.HomePage.CanCreate
}
export function Mediterranean_Categorie_Meal_can_delete(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? false : state.Meal.CanDelete
}
export function Mediterranean_HomePage_Categorie_can_delete(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? false : state.HomePage.CanDelete
}
export function Mediterranean_Categorie_Meal_page_index(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? 0 : state.Meal.PageIndex
}
export function Mediterranean_HomePage_Categorie_page_index(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? 0 : state.HomePage.PageIndex
}
export function Mediterranean_Categorie_Meal_page_size(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? 25 : state.Meal.PageSize
}
export function Mediterranean_HomePage_Categorie_page_size(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? 25 : state.HomePage.PageSize
}
export function Mediterranean_Categorie_Meal_search_query(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? null : state.Meal.SearchQuery
}
export function Mediterranean_HomePage_Categorie_search_query(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? null : state.HomePage.SearchQuery
}
export function Mediterranean_Categorie_Meal_num_pages(self:MediterraneanContext) {
  let state = self.state()
  return state.Meal == "loading" ? 1 : state.Meal.NumPages
}
export function Mediterranean_HomePage_Categorie_num_pages(self:MediterraneanContext) {
  let state = self.state()
  return state.HomePage == "loading" ? 1 : state.HomePage.NumPages
}

export function load_relation_Mediterranean_Categorie_Meal(self:MediterraneanContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Meal(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Categorie_Categorie_Meals(self.props.entity, Mediterranean_Categorie_Meal_page_index(self), Mediterranean_Categorie_Meal_page_size(self), Mediterranean_Categorie_Meal_search_query(self)).then(Meals =>
...
export function load_relation_Mediterranean_HomePage_Categorie(self:MediterraneanContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_HomePage(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Categorie_HomePage_Categories(self.props.entity, Mediterranean_HomePage_Categorie_page_index(self), Mediterranean_HomePage_Categorie_page_size(self), Mediterranean_HomePage_Categorie_search_query(self)).then(HomePages =>
        self.setState({...self.state(), update_count:self.state().update_count+1,
...
export function load_relations_Mediterranean(self, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  load_relation_Mediterranean_HomePage_Categorie(self, false, self.props.current_User, self.props.current_Admin, 
        () => load_relation_Mediterranean_Categorie_Meal(self, false, self.props.current_User, self.props.current_Admin, 
        () => callback && callback()))
}
          ...
          <div className="local_menu_entries">
            ...
            {!Permissions.can_view_Meal(self.props.current_User, self.props.current_Admin) ? null :
                  <div key={"Categorie_Meal"} className={`local_menu_entry${self.props.shown_relation == "Categorie_Meal" ? " local_menu_entry--active" : ""}`}>
                    <a onClick={() =>
                      load_relation_Mediterranean_Categorie_Meal(self,
                        false,
...
export function render_Mediterranean_Categorie_Meal(self:MediterraneanContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("mediterranean_categorie_meal",
   "Categorie",
   "Meal",
   "Meals",
  ...
  (
      state.Meal != "loading" ?
        ...
        state.Meal,
      Mediterranean_Categorie_Meal_page_index(self),
      Mediterranean_Categorie_Meal_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Meal != "loading" &&
      ...
      () =>
        <div>
          {Permissions.can_create_Meal(self.props.current_User, self.props.current_Admin) && Permissions.can_create_Categorie_Meal(self.props.current_User, self.props.current_Admin) && Mediterranean_Categorie_Meal_can_create(self) ? render_new_Mediterranean_Categorie_Meal(self) : null}
...
export function render_Mediterranean_HomePage_Categorie(self:MediterraneanContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("mediterranean_homepage_categorie",
   "Categorie",
   "HomePage",
   "HomePages",
   self.props.nesting_depth > 0,
  ...
  (
      state.HomePage != "loading" ?
        ...
        state.HomePage,
      Mediterranean_HomePage_Categorie_page_index(self),
      Mediterranean_HomePage_Categorie_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.HomePage != "loading" &&
          self.setState({...self.state(),
            ...
            <div key={i_id}>
              {
                HomePageViews.HomePage({
                  ...
                  unlink: undefined,
                    delete: !Permissions.can_delete_HomePage(self.props.current_User, self.props.current_Admin) || !Mediterranean_HomePage_Categorie_can_delete(self) ?
                    null
                    :
...
export function render_add_existing_Mediterranean_Categorie_Meal(self:MediterraneanContext) {
      ...
      <div className="button__actions">
        {
          ...
          React.createElement(List.AddToRelation,
            {
              relation_name:"mediterranean_categorie_meal",
...
export function render_new_Mediterranean_Categorie_Meal(self:MediterraneanContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Categorie_Categorie_Meals_Lunch(self.props.entity).then(e => {
                              ...
                              Api.update_Lunch(
                                ...
                                load_relation_Mediterranean_Categorie_Meal(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Meal:"closed"})
                                  )
                                )
                          })
...
export let Mediterranean_to_page = (id:number) => {
  let can_edit = Utils.any_of([Permissions.can_edit_Mediterranean, Permissions.can_edit_Categorie_Meal, Permissions.can_edit_HomePage_Categorie, Permissions.can_edit_Meal, Permissions.can_edit_HomePage])
