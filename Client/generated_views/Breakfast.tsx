...
export function Breakfast_Categorie_Meal_can_create(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? false : state.Categorie.CanCreate
}
export function Breakfast_Meal_Recipe_can_create(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? false : state.Recipe.CanCreate
}
export function Breakfast_Categorie_Meal_can_delete(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? false : state.Categorie.CanDelete
}
export function Breakfast_Meal_Recipe_can_delete(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? false : state.Recipe.CanDelete
}
export function Breakfast_Categorie_Meal_page_index(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 0 : state.Categorie.PageIndex
}
export function Breakfast_Meal_Recipe_page_index(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 0 : state.Recipe.PageIndex
}
export function Breakfast_Categorie_Meal_page_size(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 25 : state.Categorie.PageSize
}
export function Breakfast_Meal_Recipe_page_size(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 25 : state.Recipe.PageSize
}
export function Breakfast_Categorie_Meal_search_query(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? null : state.Categorie.SearchQuery
}
export function Breakfast_Meal_Recipe_search_query(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? null : state.Recipe.SearchQuery
}
export function Breakfast_Categorie_Meal_num_pages(self:BreakfastContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 1 : state.Categorie.NumPages
}
export function Breakfast_Meal_Recipe_num_pages(self:BreakfastContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 1 : state.Recipe.NumPages
}

export function load_relation_Breakfast_Categorie_Meal(self:BreakfastContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Categorie(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Meal_Categorie_Meals(self.props.entity, Breakfast_Categorie_Meal_page_index(self), Breakfast_Categorie_Meal_page_size(self), Breakfast_Categorie_Meal_search_query(self)).then(Categories =>
...
export function load_relation_Breakfast_Meal_Recipe(self:BreakfastContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Recipe(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Meal_Meal_Recipes(self.props.entity, Breakfast_Meal_Recipe_page_index(self), Breakfast_Meal_Recipe_page_size(self), Breakfast_Meal_Recipe_search_query(self)).then(Recipes =>
        self.setState({...self.state(), update_count:self.state().update_count+1,
...
export function load_relations_Breakfast(self, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  load_relation_Breakfast_Meal_Recipe(self, false, self.props.current_User, self.props.current_Admin, 
        () => load_relation_Breakfast_Categorie_Meal(self, false, self.props.current_User, self.props.current_Admin, 
        () => callback && callback()))
}
...
export function render_Breakfast_Description_editable_minimised(self:BreakfastContext) : JSX.Element {
  if (!Permissions.can_edit_Breakfast(self.props.current_User, self.props.current_Admin)) return render_Breakfast_Description_minimised(self)
  else
    return !Permissions.can_view_Breakfast_Description(self.props.current_User, self.props.current_Admin) ? <div /> :
          <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Breakfast(self.props.current_User, self.props.current_Admin) && Permissions.can_edit_Breakfast_Description(self.props.current_User, self.props.current_Admin),
        self.props.mode,
...
export function render_Breakfast_Description_editable_maximised(self:BreakfastContext) : JSX.Element {
  if (!Permissions.can_edit_Breakfast(self.props.current_User, self.props.current_Admin)) return render_Breakfast_Description_maximised(self)
  else
    return !Permissions.can_view_Breakfast_Description(self.props.current_User, self.props.current_Admin) ? <div /> :
          <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
...
export function render_editable_attributes_minimised_Breakfast(self:BreakfastContext) {
  let attributes = (<div>
      {render_Breakfast_Description_editable_minimised(self)}
    </div>)
  return attributes
}
          ...
          <div className="local_menu_entries">
            ...
            {!Permissions.can_view_Recipe(self.props.current_User, self.props.current_Admin) ? null :
                  <div key={"Meal_Recipe"} className={`local_menu_entry${self.props.shown_relation == "Meal_Recipe" ? " local_menu_entry--active" : ""}`}>
                    <a onClick={() =>
                      load_relation_Breakfast_Meal_Recipe(self,
                        false,
...
export function render_controls_Breakfast(self:BreakfastContext) {
  return <div className="control">
    ...
    {Permissions.can_delete_Breakfast(self.props.current_User, self.props.current_Admin) && self.props.size == "fullscreen" ? <a className="button button--delete"
...
export function render_Breakfast_Description_minimised(self:BreakfastContext) : JSX.Element {
      return !Permissions.can_view_Breakfast_Description(self.props.current_User, self.props.current_Admin) ? null : <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
  <div className="model__attribute-content">
    { Components.String(
        self.props.is_editable && Permissions.can_edit_Breakfast(self.props.current_User, self.props.current_Admin) && Permissions.can_edit_Breakfast_Description(self.props.current_User, self.props.current_Admin),
...
export function render_Breakfast_Description_maximised(self:BreakfastContext) : JSX.Element {
        return !Permissions.can_view_Breakfast_Description(self.props.current_User, self.props.current_Admin) ? null : <div className="model__attribute description">
  <label className="attribute-label attribute-label-description">{i18next.t(`Breakfast:Description`, {context: self.props.inline ? "inline" : ""})}</label>
  <div className="model__attribute-content">
    { Components.String(
...
export function render_preview_Breakfast(self:BreakfastContext) {
  ...
  if (self.props.mode == "view" || !Permissions.can_edit_Breakfast(self.props.current_User, self.props.current_Admin))
    attributes = (<div className="model__attributes">
      { render_Breakfast_Description_minimised(self) }
    </div>)
  else
...
export function render_Breakfast_Categorie_Meal(self:BreakfastContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("breakfast_categorie_meal",
   "Meal",
   "Categorie",
   "Categories",
  ...
  (
      state.Categorie != "loading" ?
        ...
        state.Categorie,
      Breakfast_Categorie_Meal_page_index(self),
      Breakfast_Categorie_Meal_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Categorie != "loading" &&
...
export function render_Breakfast_Meal_Recipe(self:BreakfastContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("breakfast_meal_recipe",
   "Meal",
   "Recipe",
   "Recipes",
   self.props.nesting_depth > 0,
  ...
  (
      state.Recipe != "loading" ?
        ...
        state.Recipe,
      Breakfast_Meal_Recipe_page_index(self),
      Breakfast_Meal_Recipe_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Recipe != "loading" &&
          self.setState({...self.state(),
...
export function render_relations_Breakfast(self:BreakfastContext) {
  return <div className="relations">
      { render_Breakfast_Meal_Recipe(self, "default") }
      
    </div>
}

export function render_add_existing_Breakfast_Categorie_Meal(self:BreakfastContext) {
...
export function render_add_existing_Breakfast_Meal_Recipe(self:BreakfastContext) {
...
export function render_new_Breakfast_Categorie_Meal(self:BreakfastContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Categorie_Meals_American(self.props.entity).then(e => {
                              ...
                              Api.update_American(
                                ...
                                load_relation_Breakfast_Categorie_Meal(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Categorie:"closed"})
                                  )
                                )
                          })
...
export function render_new_Breakfast_Meal_Recipe(self:BreakfastContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                              ...
                              Api.update_Recipe(
                                ...
                                load_relation_Breakfast_Meal_Recipe(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Recipe:"closed"})
                                  )
                                )
                          })
...
export let Breakfast_to = (id:number, target_element_id:string, current_User:Models.User, current_Admin:Models.Admin) => {
