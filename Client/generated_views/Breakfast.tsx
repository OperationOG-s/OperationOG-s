...
export function Breakfast_Categories_Meal_can_create(self:BreakfastContext) {
...
export function Breakfast_Categories_Meal_can_delete(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Categories_Meal_page_index(self:BreakfastContext) {
  let state = self.state()
...
export function Breakfast_Categories_Meal_page_size(self:BreakfastContext) {
  let state = self.state()
...
export function render_Breakfast_Categories_Meal(self:BreakfastContext, context:"presentation_structure"|"default") {
  ...
  (
      ...
      () =>
        <div>
          {Permissions.can_create_Categories(self.props.current_User, self.props.current_Admin) && Permissions.can_create_Categories_Meal(self.props.current_User, self.props.current_Admin) && Breakfast_Categories_Meal_can_create(self) ? render_new_Breakfast_Categories_Meal(self) : null}
          {Permissions.can_create_Categories_Meal(self.props.current_User, self.props.current_Admin) ? render_add_existing_Breakfast_Categories_Meal(self) : null}
        </div>)
    }
...
export function render_add_existing_Breakfast_Categories_Meal(self:BreakfastContext) {
      ...
      <div className="button__actions">
        {
          ...
          React.createElement(List.AddToRelation,
            {
              relation_name:"breakfast_categories_meal",
              source_name:"Meal",
              target_name:"Categories",
...
export function render_new_Breakfast_Categories_Meal(self:BreakfastContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
