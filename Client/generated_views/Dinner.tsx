...
export function Dinner_Categorie_Meal_can_create(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? false : state.Categorie.CanCreate
}
export function Dinner_Meal_Recipe_can_create(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? false : state.Recipe.CanCreate
}
export function Dinner_Categorie_Meal_can_delete(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? false : state.Categorie.CanDelete
}
export function Dinner_Meal_Recipe_can_delete(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? false : state.Recipe.CanDelete
}
export function Dinner_Categorie_Meal_page_index(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 0 : state.Categorie.PageIndex
}
export function Dinner_Meal_Recipe_page_index(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 0 : state.Recipe.PageIndex
}
export function Dinner_Categorie_Meal_page_size(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 25 : state.Categorie.PageSize
}
export function Dinner_Meal_Recipe_page_size(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 25 : state.Recipe.PageSize
}
export function Dinner_Categorie_Meal_search_query(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? null : state.Categorie.SearchQuery
}
export function Dinner_Meal_Recipe_search_query(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? null : state.Recipe.SearchQuery
}
export function Dinner_Categorie_Meal_num_pages(self:DinnerContext) {
  let state = self.state()
  return state.Categorie == "loading" ? 1 : state.Categorie.NumPages
}
export function Dinner_Meal_Recipe_num_pages(self:DinnerContext) {
  let state = self.state()
  return state.Recipe == "loading" ? 1 : state.Recipe.NumPages
}

export function load_relation_Dinner_Categorie_Meal(self:DinnerContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Categorie(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Meal_Categorie_Meals(self.props.entity, Dinner_Categorie_Meal_page_index(self), Dinner_Categorie_Meal_page_size(self), Dinner_Categorie_Meal_search_query(self)).then(Categories =>
...
export function load_relation_Dinner_Meal_Recipe(self:DinnerContext, force_first_page:boolean, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  let state = self.state()
  ...
  Permissions.can_view_Recipe(current_User, current_Admin) ?
    prelude(() =>
      Api.get_Meal_Meal_Recipes(self.props.entity, Dinner_Meal_Recipe_page_index(self), Dinner_Meal_Recipe_page_size(self), Dinner_Meal_Recipe_search_query(self)).then(Recipes =>
        self.setState({...self.state(), update_count:self.state().update_count+1,
...
export function load_relations_Dinner(self, current_User:Models.User, current_Admin:Models.Admin, callback?:()=>void) {
  load_relation_Dinner_Meal_Recipe(self, false, self.props.current_User, self.props.current_Admin, 
        () => load_relation_Dinner_Categorie_Meal(self, false, self.props.current_User, self.props.current_Admin, 
        () => callback && callback()))
}
          ...
          <div className="local_menu_entries">
            ...
            {!Permissions.can_view_Recipe(self.props.current_User, self.props.current_Admin) ? null :
                  <div key={"Meal_Recipe"} className={`local_menu_entry${self.props.shown_relation == "Meal_Recipe" ? " local_menu_entry--active" : ""}`}>
                    <a onClick={() =>
                      load_relation_Dinner_Meal_Recipe(self,
                        false,
...
export function render_Dinner_Categorie_Meal(self:DinnerContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("dinner_categorie_meal",
   "Meal",
   "Categorie",
   "Categories",
  ...
  (
      state.Categorie != "loading" ?
        ...
        state.Categorie,
      Dinner_Categorie_Meal_page_index(self),
      Dinner_Categorie_Meal_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Categorie != "loading" &&
...
export function render_Dinner_Meal_Recipe(self:DinnerContext, context:"presentation_structure"|"default") {
  ...
  return <div>
    ...
    { List.render_relation("dinner_meal_recipe",
   "Meal",
   "Recipe",
   "Recipes",
   self.props.nesting_depth > 0,
  ...
  (
      state.Recipe != "loading" ?
        ...
        state.Recipe,
      Dinner_Meal_Recipe_page_index(self),
      Dinner_Meal_Recipe_num_pages(self),
      new_page_index => {
          let state = self.state()
          state.Recipe != "loading" &&
          self.setState({...self.state(),
...
export function render_relations_Dinner(self:DinnerContext) {
  return <div className="relations">
      { render_Dinner_Meal_Recipe(self, "default") }
      
    </div>
}

export function render_add_existing_Dinner_Categorie_Meal(self:DinnerContext) {
...
export function render_add_existing_Dinner_Meal_Recipe(self:DinnerContext) {
...
export function render_new_Dinner_Categorie_Meal(self:DinnerContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Categorie_Meals_American(self.props.entity).then(e => {
                              ...
                              Api.update_American(
                                ...
                                load_relation_Dinner_Categorie_Meal(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Categorie:"closed"})
                                  )
                                )
                          })
...
export function render_new_Dinner_Meal_Recipe(self:DinnerContext) {
    let state = self.state()
    return  self.props.mode == "edit" ?
      <div className="button__actions">
                      ...
                      onClick={() =>
                          Api.create_linked_Meal_Meal_Recipes_Recipe(self.props.entity).then(e => {
                              ...
                              Api.update_Recipe(
                                ...
                                load_relation_Dinner_Meal_Recipe(self, true, self.props.current_User, self.props.current_Admin, () =>
                                    self.setState({...self.state(), add_step_Recipe:"closed"})
                                  )
                                )
                          })
