...
namespace PortableRecipes.Data
{
  public static class PortableRecipesContextSeeds
  {
    ...
    static American[] Americans = null;
     static Action seed_Recommended_Recipess = null;
    static Recommended_Recipes[] Recommended_Recipess = null;
    ...
    static Admin[] Admins = null;
     static Action seed_BookmarkedRecipess = null;
    static BookmarkedRecipes[] BookmarkedRecipess = null;
    ...
    public static void Initialize(PortableRecipesContext context)
    {
      ...
      seed_Recommended_Recipess = () => {
        
        if (!context.Recommended_Recipes.Any())
        {
          var _Recommended_Recipes = new System.Collections.Generic.List<Recommended_Recipes>();
          
          
            
            _Recommended_Recipes.Add(new Recommended_Recipes { CreatedDate = DateTime.Now,   });
          ...
          foreach (var x in _Recommended_Recipes)
          {
            context.Recommended_Recipes.Add(x);
          }
          context.SaveChanges();
        }
        Recommended_Recipess = context.Recommended_Recipes.ToArray();
      };
      seed_Meals = () => {
      ...
      seed_BookmarkedRecipess = () => {
        
        if (!context.BookmarkedRecipes.Any())
        {
          var _BookmarkedRecipes = new System.Collections.Generic.List<BookmarkedRecipes>();
          
          
            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "5739-0744",   });

            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "c23d-d958",   });

            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "390c-c8a1",   });

            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "9253-9081",   });

            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "ea2b-c453",   });

            
            _BookmarkedRecipes.Add(new BookmarkedRecipes { CreatedDate = DateTime.Now, Title = "9f20-8065",   });

          foreach (var x in _BookmarkedRecipes)
          {
            context.BookmarkedRecipes.Add(x);
          }
          context.SaveChanges();
        }
        BookmarkedRecipess = context.BookmarkedRecipes.ToArray();
      };
      seed_Dinners = () => {
