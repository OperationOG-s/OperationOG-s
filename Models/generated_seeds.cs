...
namespace PortableRecipes.Data
{
  public static class PortableRecipesContextSeeds
  {
    ...
    static Dinner[] Dinners = null;
     static Action seed_Categories = null;
    static Categorie[] Categories = null;
    ...
    public static void Initialize(PortableRecipesContext context)
    {
      ...
      seed_Categories = () => {
        ...
        {
          var _Categorie = new System.Collections.Generic.List<Categorie>();
          // nothing here: class is abstract
          
          foreach (var x in _Categorie)
          {
            context.Categorie.Add(x);
          }
          context.SaveChanges();
        }
        Categories = context.Categorie.ToArray();
      };
      seed_Mediterraneans = () => {
      ...
      {
        var _Categorie_Meal = new Categorie_Meal[]
        {
            
            new Categorie_Meal { CategorieId = 3, MealId = 1 },

            new Categorie_Meal { CategorieId = 3, MealId = 2 },

            new Categorie_Meal { CategorieId = 3, MealId = 3 },

            new Categorie_Meal { CategorieId = 2, MealId = 1 },

            new Categorie_Meal { CategorieId = 2, MealId = 2 },

            new Categorie_Meal { CategorieId = 2, MealId = 3 },

            new Categorie_Meal { CategorieId = 1, MealId = 1 },

            new Categorie_Meal { CategorieId = 1, MealId = 2 },

            new Categorie_Meal { CategorieId = 1, MealId = 3 },

        };
        foreach (var x in _Categorie_Meal)
        {
          context.Categorie_Meal.Add(x);
        }
        context.SaveChanges();
      }
      var Categorie_Meal = context.Categorie_Meal.ToArray();
      ...
      if (!context.Meal_Recipe.Any())
      {
        var _Meal_Recipe = new Meal_Recipe[]
        {
            ...
            new Meal_Recipe { MealId = 3, RecipeId = 11 },

            new Meal_Recipe { MealId = 3, RecipeId = 12 },

            new Meal_Recipe { MealId = 3, RecipeId = 15 },

            new Meal_Recipe { MealId = 3, RecipeId = 10 },

            new Meal_Recipe { MealId = 3, RecipeId = 9 },

            new Meal_Recipe { MealId = 3, RecipeId = 7 },

            new Meal_Recipe { MealId = 3, RecipeId = 5 },

            new Meal_Recipe { MealId = 1, RecipeId = 8 },

            new Meal_Recipe { MealId = 1, RecipeId = 11 },

            new Meal_Recipe { MealId = 1, RecipeId = 13 },

            new Meal_Recipe { MealId = 1, RecipeId = 14 },

            new Meal_Recipe { MealId = 1, RecipeId = 15 },

            new Meal_Recipe { MealId = 1, RecipeId = 9 },

            new Meal_Recipe { MealId = 2, RecipeId = 6 },

            new Meal_Recipe { MealId = 2, RecipeId = 16 },

            new Meal_Recipe { MealId = 2, RecipeId = 17 },
