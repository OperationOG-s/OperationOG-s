    ...
    public static void Initialize(PortableRecipesContext context)
    {
      ...
      if (!context.Meal_Recipe.Any())
      {
        var _Meal_Recipe = new Meal_Recipe[]
        {
            ...
            new Meal_Recipe { MealId = 3, RecipeId = 1 },
            ...
            new Meal_Recipe { MealId = 1, RecipeId = 10 },
      ...
      if (!context.Categorie_Recipe.Any())
      {
        var _Categorie_Recipe = new Categorie_Recipe[]
        {
            ...
            new Categorie_Recipe { CategorieId = 3, RecipeId = 7 },

            new Categorie_Recipe { CategorieId = 2, RecipeId = 6 },

            new Categorie_Recipe { CategorieId = 2, RecipeId = 4 },

            new Categorie_Recipe { CategorieId = 1, RecipeId = 2 },

            new Categorie_Recipe { CategorieId = 2, RecipeId = 5 },

            new Categorie_Recipe { CategorieId = 1, RecipeId = 10 },
        ...
        {
          context.Categorie_Recipe.Add(x);
        }
        context.SaveChanges();
      }
      var Categorie_Recipe = context.Categorie_Recipe.ToArray();
