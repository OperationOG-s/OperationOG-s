...
function ping_as_Admin() {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield fetch(`/api/v1/keep_alive/ping_as_Admin`, { method: 'get', credentials: 'include', headers: { 'content-type': 'application/json' } });
        if (!res.ok)
            throw Error(res.statusText);
        return;
    });
}
exports.ping_as_Admin = ping_as_Admin;
