...
[Route("/[controller]")]
  public class Recommended_RecipessController : Controller
  {
    private readonly MailOptions _mailOptions;
    public readonly PortableRecipesContext _context;

    public Recommended_RecipessController(PortableRecipesContext context, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult View(int id)
    {
      ...
      ViewData["id"] = id;
      ViewData["Page"] = "Recommended_Recipess/View";
      return View();
    }
  }
