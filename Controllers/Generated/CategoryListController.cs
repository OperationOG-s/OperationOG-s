...
[Route("/[controller]")]
  public class CategoryListsController : Controller
  {
    ...
    public CategoryListsController(PortableRecipesContext context, IHostingEnvironment env, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public IActionResult View(int id)
    {
      ...
      ViewData["id"] = id;
      ViewData["Page"] = "CategoryLists/View";
      return View();
    }
  }
