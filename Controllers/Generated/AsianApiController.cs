...
using System.IO;
  ...
  public class AsianApiController : Controller
  {
    ...
    public AsianApiController(PortableRecipesContext context, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
    ...
    public ItemWithEditable<Asian> GetById(int id)
    {
      ...
      var item = PortableRecipes.Models.Asian.FilterViewableAttributesLocal(current_User, current_Admin)(allowed_items.FirstOrDefault(e => e.Id == id));
    ...
    public Page<Asian> GetAll([FromQuery] int page_index, [FromQuery] int page_size = 25)
    {
      ...
      return allowed_items
        ...
        .Paginate(can_create_by_token, can_delete_by_token, false, page_index, page_size, PortableRecipes.Models.Asian.WithoutImages, item => item);
    }
