...
namespace PortableRecipes.Filters
{
  public class RestrictToUserTypeAttribute : ActionFilterAttribute
  {
    ...
    public override void OnActionExecuting(ActionExecutingContext context)
    {
      ...
      var _context = controller._context as PortableRecipesContext;
...
namespace PortableRecipes
{
  public static class ApplicationSessionManager {
    ...
    public static void ChangedPassword<U>(this HttpContext HttpContext, PortableRecipesContext _context, string entity_name, U entity) where U : IEntity {
